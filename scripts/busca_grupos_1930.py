...
web = f"https://es.wikipedia.org/wiki/Copa_Mundial_de_F%C3%BAtbol_de_1930"
...
for des0, des1 in enumerate(data_grupo_0):
    ...
    for des4 in data_grupo_11:
        ...
        lst_col_tr1 = []
        confirm_grupo = des4.find_element(By.XPATH, f"//preceding::h4//span[contains(@id, 'Grupo_{str(des0+1)}')]")

        print("confirm_grupo: ", confirm_grupo)
        ...
        lst_col_tr1.append(confirm_grupo.text.strip())
...
df_base["year"] = "1930"
df_base.to_csv("grupos_mundiales_1930.csv")