...
web = f"https://es.wikipedia.org/wiki/Copa_Mundial_de_F%C3%BAtbol_de_1966"
...
for des0, des1 in enumerate(data_grupo_0[:]):
    ...
    confirm_grupo = des1.find_elements(By.XPATH, f".//preceding::h3//span[contains(@id, 'Grupo_')]")
...
df_base["year"] = "1966"
df_base.to_csv("grupos_mundiales_1966.csv")