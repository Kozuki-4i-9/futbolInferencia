...
web = f"https://es.wikipedia.org/wiki/Copa_Mundial_de_F%C3%BAtbol_de_2010"
...
for des0, des1 in enumerate(data_grupo_0[4:]):
...
df_base["year"] = "2010"
df_base.to_csv("grupos_mundiales_2010.csv")