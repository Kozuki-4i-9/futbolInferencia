...
web = f"https://es.wikipedia.org/wiki/Copa_Mundial_de_F%C3%BAtbol_de_1950"
...
for des0, des1 in enumerate(data_grupo_0[:-1]):
    data_grupo_ = des1.find_elements(By.XPATH, ".//child::tr")
    # tr de la cabecera
    data_grupo_10 = data_grupo_[0]
    # tr para los grupos
    data_grupo_11 = data_grupo_[1:]
    confirm_grupo = des1.find_elements(By.XPATH, f".//preceding::div[contains(@class, 'mw-heading mw-heading4')]//h4[contains(@id, 'Grupo_')]")[4:]
    #ultimo_grupo = des1.find_elements(By.XPATH, f"preceding::div[contains(@class, 'mw-heading mw-heading3')]//h3[contains(@id, 'Fase_final_2')]")
    
    confirm_grupo = confirm_grupo# + ultimo_grupo
...
# //a[contains(@title, 'Selección de fútbol de')]//preceding::table[@style='background: #f9f9f9; border: 1px #aaa solid; border-collapse: collapse; font-size: 95%;' and @cellpadding='3']//tbody//preceding::div[contains(@class, 'mw-heading mw-heading3')]//h3[contains(@id, 'Fase_final_2')]
...
df_base.to_csv(dir_gen + "grupos_mundiales_1950.csv")