...
web = f"https://es.wikipedia.org/wiki/Copa_Mundial_de_F%C3%BAtbol_de_2006"
...
data_grupo_0 = base.find_elements(By.XPATH, "//preceding::table[@style='background: #f9f9f9; border: 1px #aaa solid; border-collapse: collapse; font-size: 95%;']//tbody")

lst_col_tr0 = np.array([])
cabecera_t = []

# me itero sobre todas (8) las tablas
for des0, des1 in enumerate(data_grupo_0[2:]):
    ...
    for des4 in data_grupo_11:
        ...
        confirm_grupo = des4.find_elements(By.XPATH, ".//preceding::h4//span[contains(@id, 'Grupo_')][1]")
...
df_base["year"] = "2006"
df_base.to_csv("grupos_mundiales_2006.csv")