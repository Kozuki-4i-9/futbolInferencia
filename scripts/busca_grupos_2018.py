...
web = f"https://es.wikipedia.org/wiki/Copa_Mundial_de_F%C3%BAtbol_de_2018"
...
for des0, des1 in enumerate(data_grupo_0):
    ...
    for des4 in data_grupo_11:
        ...
        confirm_grupo = des4.find_element(By.XPATH, ".//preceding::h3[1]//span[contains(@id, 'Grupo_')][1]").text.strip()
...
df_base["year"] = "2018"
df_base.to_csv("grupos_mundiales_2018.csv")